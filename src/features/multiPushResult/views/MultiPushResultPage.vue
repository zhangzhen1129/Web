...
import checkboxCheckedAsset from '../../loanSuccess/assets/checkbox-checked.svg'
import checkboxUncheckedAsset from '../../loanSuccess/assets/checkbox-unchecked.svg'
import interceptIconAsset from '../../loanSuccess/assets/intercept-icon.svg'
import reviewRefreshAsset from '../../loanSuccess/assets/review-refresh.svg'
import reviewStarAsset from '../../loanSuccess/assets/review-star.png'
import reviewStarLowAsset from '../../loanSuccess/assets/review-star-low.png'
import starEmptyAsset from '../../loanSuccess/assets/star-empty.png'
import starFilledAsset from '../../loanSuccess/assets/star-filled.png'
import successIllustrationAsset from '../../loanSuccess/assets/success-illustration.png'
import vipBadgeAsset from '../../loanSuccess/assets/vip-badge.png'
...
import { LOAN_SUCCESS_TEXT } from '../../loanSuccess/loanSuccessText.js'
import '../../loanSuccess/views/loanSuccessPage.css'
import './multiPushResultPage.css'
import { createMultiPushResultServices } from '../services/multiPushResultServices.js'
...
function createOperationId(sequence) {
  return `multi-push-result-${Date.now().toString(36)}-${sequence.toString(36)}`
}

const controller = createLoanSuccessController({
  services: createMultiPushResultServices({ getGlobalState: () => globalStore }),
...
<template>
  ...
  >
    ...
    <Popup
      :show="state.overlay === 'back_intercept'"
      teleport="body"
      position="center"
      class="multi-push-result-popup"
